    ...
    [
        ...
        describe(name, () => {
            ...
            describe('simple widget', () => {
                ...
                const html = `<div id="0123456789abcdef"><section>625</section></div><script type="text/javascript">Object.assign(["__WIDGET_DATA__","simple${suffix}","instances","0123456789abcdef"].reduce(function(a,b){return a[b]=a[b]||{};},window),{"props":{"power":4},"hydration":{"${keyFor(`simple${suffix}`, {power: 4})}":{"baseValue":5}}});</script>`;
